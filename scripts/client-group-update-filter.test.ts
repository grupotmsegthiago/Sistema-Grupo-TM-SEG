...
test('sem print colado NÃO envia', () => {
    assert.equal(shouldSendClientGroupWhatsApp({ ...base, hasExplicitPrint: false }), false);
});

test('print colado sem mudança de status NÃO envia (ex.: só agentes)', () => {
