-- Fase 4 RH RLS — lockdown de public.rh_employee_bank_accounts.
...
BEGIN
  ...
  IF policy_total <> 1 OR expected_policy_total <> 1 THEN
    RAISE EXCEPTION
      'Drift em policies de public.rh_employee_bank_accounts: total=%, esperada=%',
      policy_total,
...
DROP POLICY IF EXISTS "Allow all for rh_employee_bank_accounts"
