/** SQL embutido para Vercel (migrations/ não está no cwd do serverless). */
export const TIMECLOCK_FIX_USER_ID_SQL = `-- rh_employees.user_id compatível com system_users.id (inteiro como texto)
DO $$
BEGIN
  IF EXISTS (
