...
const EscoltaViaturaIcon: React.FC<Props> = ({ className = 'h-5 w-auto', title = 'Viatura de escolta' }) => (
  <svg
    viewBox="0 0 96 28"
    className={className}
  ...
  >
    <title>{title}</title>
    {/* Rodas */}
    <circle cx="22" cy="21" r="4.2" fill="#111827" />
    <circle cx="68" cy="21" r="4.2" fill="#111827" />
    <circle cx="22" cy="21" r="1.6" fill="#f3f4f6" opacity="0.35" />
    <circle cx="68" cy="21" r="1.6" fill="#f3f4f6" opacity="0.35" />
    {/* Carroceria */}
    <path
      fill="#111827"
    ...
    />
    {/* Vidros (recorte escuro sobre a carroceria) */}
    <path
      fill="#374151"
      d="M24.5 11.8h11.2l2.6 3.2H27.8l-3.3-3.2zm15.8 0h10.8l3.4 3.2H43.8l-3.5-3.2z"
    />
    {/* Farol dianteiro */}
    <path fill="#6b7280" d="M83.5 14.2h2.8v2.4h-2.8a1.2 1.2 0 1 1 0-2.4z" />
  </svg>
);
