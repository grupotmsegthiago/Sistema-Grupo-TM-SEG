...
const ClientContractTab: React.FC<Props> = ({
  ...
  const generatePDF = (contract: ContractData) => {
    ...
    const clauses = [
      ...
      { title: 'CLÁUSULA TERCEIRA: DAS OBRIGAÇÕES DA CONTRATADA', body: 'Além de outras obrigações legais ou contratuais, são responsabilidades específicas e exclusivas da CONTRATADA:' },
      ...
      { title: '', body: '§4º: A CONTRATADA deverá manter durante toda a execução do contrato, em compatibilidade com as obrigações por ela assumidas, todas as condições de habilitação e qualificação exigidas.' },
      { title: '', body: '§5º: Manter os equipamentos e veículos em perfeitas condições de uso e com as devidas manutenções em dia.' },
      { title: '', body: '§6º: Providenciar a imediata substituição de qualquer funcionário cujo comportamento seja considerado inadequado pela CONTRATANTE.' },
      { title: '', body: '§7º: Responsabilizar-se por todos os encargos trabalhistas, previdenciários, fiscais e comerciais resultantes da execução do contrato.' },
      { title: '', body: '§8º: Cumprir com as leis, regulamentos e normas que regem os serviços;' },
      { title: '', body: '§9º: Obter, às suas próprias custas, as licenças, alvarás, permissões, autorizações e outros documentos exigidos para a execução do objeto deste Contrato;' },
      { title: '', body: '§10º: Fornecer aos seus funcionários os equipamentos de proteção individuais (EPIs) necessários;' },
      { title: '', body: '§11º: Assegurar que seus funcionários estejam portando crachás de identificação e utilizando os EPIs;' },
      { title: '', body: '§12º: Contratar e manter, durante toda a vigência deste Contrato, uma apólice de seguro de garantia judicial em favor da CONTRATANTE e seu cliente final;' },
      { title: '', body: '§13º: Apresentar mensalmente e em conjunto com a Nota Fiscal todos os documentos de registro de seus funcionários e guias comprobatórias de recolhimento dos encargos trabalhistas;' },
      { title: '', body: '§14º: Caso a CONTRATANTE não aceite os serviços entregues pela CONTRATADA, a CONTRATADA obriga-se a refazer, alterar, melhorar, corrigir e/ou completar os serviços, sem quaisquer ônus adicionais;' },
      { title: '', body: '§15º: A CONTRATADA deverá manter pessoa responsável (supervisor) em contato direto com os funcionários que estiverem executando os serviços contratados.' },
      { title: 'CLÁUSULA QUARTA: DO PREÇO', body: 'Pelo efetivo desempenho das atividades dispostas na cláusula 1ª deste contrato, a CONTRATADA receberá o valor proposto pela CONTRATANTE na proposta enviada, cuja proposta para o serviço será encaminhada em tempo oportuno.' },
      ...
      { title: 'CLÁUSULA QUINTA: DA RESPONSABILIDADE CIVIL', body: 'A CONTRATADA é responsável pelos danos causados diretamente à CONTRATANTE ou a terceiros, decorrentes de sua culpa ou dolo na execução dos serviços, não excluindo ou reduzindo essa responsabilidade a fiscalização ou o acompanhamento pela CONTRATANTE.' },
      ...
      { title: 'CLÁUSULA SEXTA: DA DURAÇÃO DO CONTRATO', body: 'O presente Contrato é celebrado por prazo indeterminado, podendo ser resilido por qualquer das partes, a qualquer tempo, mediante notificação prévia por escrito, sem incidência de penalidade, ressalvadas as obrigações já constituídas até a data da efetiva rescisão.' },
      ...
      { title: 'CLÁUSULA OITAVA: DAS OBRIGAÇÕES DA CONTRATANTE', body: 'São responsabilidades exclusivas da CONTRATANTE:' },
