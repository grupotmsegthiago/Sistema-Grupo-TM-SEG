      ...
      <div className={embedded ? '' : 'bg-white rounded-2xl border border-gray-100 p-6 shadow-sm'}>
        ...
        {activeTab === 'empresa' && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div><label className={RH_LABEL_CLASS}>Turno</label><select className={RH_SELECT_CLASS} value={form.shift_type || 'diurno'} onChange={(e) => set('shift_type', e.target.value)}><option value="diurno">Diurno (entrada após 07:30)</option><option value="noturno">Noturno (entrada após 19:30)</option></select></div>
