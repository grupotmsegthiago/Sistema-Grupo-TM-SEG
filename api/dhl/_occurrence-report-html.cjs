...
var generateReportHtml_exports = {};
__export(generateReportHtml_exports, {
  dhlOccurrenceReportFilename: () => dhlOccurrenceReportFilename,
  generateDhlOccurrenceReportHtml: () => generateDhlOccurrenceReportHtml,
  getPublicBaseUrl: () => getPublicBaseUrl2,
  resolveTmSegLogoDataUri: () => resolveTmSegLogoDataUri
});
module.exports = __toCommonJS(generateReportHtml_exports);
