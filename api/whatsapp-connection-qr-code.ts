/** GET /api/whatsapp/connection/qr-code — leve */
import { assertWhatsappAdminAccess, readBearer } from "../lib/tmsegAuth.js";
import { getQrAndPhoneCode } from "../lib/whatsappLiteApi.js";
...
export default async function handler(req: { method?: string; query?: Record<string, string> }, res: {
  ...
  try {
    const result = await getQrAndPhoneCode(req.query?.instanceId || null);
