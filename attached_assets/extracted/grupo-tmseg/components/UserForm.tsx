      ...
      try {
          ...
          if (data) {
              setFormData({
                  name: data.name,
                  email: data.email,
                  password: data.password, // Em produção real, não retornaria a senha
  ...
  const handleSubmit = async (e: React.FormEvent) => {
      ...
      try {
          const payload = {
              ...
              force_password_change: !id // Força troca se for novo
          };
          ...
          if (id) {
              ...
              if (data && data[0]) {
                  ...
                  try {
                      ...
                      showNotification('Email Enviado', 'Credenciais enviadas ao usuário.', 'info');
                  } catch (mailErr) {
