...
export const NAV_ITEMS: NavItem[] = [
  ...
  { name: 'Jurídico', icon: 'Scale', id: 'legal-dashboard' },
  {
    ...
    children: [
      ...
      { name: 'Admissão', id: 'rh-admissions' },
      { name: 'Cargos', id: 'rh-positions' },
      { name: 'Departamentos', id: 'rh-departments' },
      { name: 'Salários', id: 'rh-salaries' },
      { name: 'Benefícios', id: 'rh-benefits' },
      { name: 'Jornada de Trabalho', id: 'rh-work-schedule' },
      { name: 'Registro de Ponto', id: 'rh-timeclock' },
      { name: 'Relatório de Ponto', id: 'rh-point-report' },
      { name: 'Comissão', id: 'rh-commissions' },
      { name: 'Premiações', id: 'rh-awards' },
      { name: 'Bonificações', id: 'rh-bonuses' },
      { name: 'Advertências', id: 'rh-warnings' },
      { name: 'Férias', id: 'rh-vacations' },
      { name: 'Afastamentos', id: 'rh-leaves' },
      { name: 'Exames', id: 'rh-exams' },
      { name: 'Holerites', id: 'rh-payslips' },
      { name: 'Folha de Pagamento', id: 'rh-payroll' },
      { name: 'Relatórios', id: 'rh-reports' },
      { name: 'Configurações', id: 'rh-settings' },
    ],
  },
