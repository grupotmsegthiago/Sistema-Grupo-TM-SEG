...
export const NAV_ITEMS: NavItem[] = [
  { name: 'Página Inicial', icon: 'LayoutDashboard', id: 'dashboard' },
  {
    ...
    children: [
      ...
      { name: 'Gestor Comercial IA', id: 'gc-dashboard' },
      { name: 'Inteligência Comercial', id: 'gc-intelligence' },
      { name: 'Metas', id: 'gc-goals' },
      { name: 'Comissões', id: 'gc-commissions' },
      { name: 'Ranking Comercial', id: 'gc-ranking' },
      { name: 'Saúde dos Clientes', id: 'gc-client-health' },
      { name: 'Configurações Comerciais', id: 'gc-settings' },
      { name: 'Controle de Permissões', id: 'gc-permissions' },
