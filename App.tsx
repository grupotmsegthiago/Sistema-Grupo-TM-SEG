...
const App: React.FC = () => {
  ...
  return (
    <NotificationProvider>
        ...
        {(() => { try { const u = JSON.parse(localStorage.getItem('userData') || '{}'); const r = (u.role || '').toLowerCase(); return r !== 'controller' && r !== 'cliente' && !u.client_id; } catch { return true; } })() && <MissionAlertMonitor />}
