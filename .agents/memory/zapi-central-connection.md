...
- Número oficial da Central: (11) 92683-9456, instância mobile "Central Torres". Reconexão por número usa o fluxo mobile da Z-API (`/mobile/request-registration-code` → SMS → `/mobile/confirm-registration-code`), mas o usuário consegue concluir pelo painel da Z-API sozinho.
