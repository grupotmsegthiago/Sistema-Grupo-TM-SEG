...
## Fim de missão DHL usa o MESMO padrão ESCOLTA ARMADA

No fim de missão de OS DHL, o texto enviado ao grupo/copiado é o padrão "ESCOLTA ARMADA" (com FIM DE OPERAÇÃO preenchido) — NUNCA o texto interno "DADOS DA MISSÃO" com KM inicial/final.
**Why:** padrão oficial acordado com o cliente DHL (jul/2026); o relatório interno com KM não deve aparecer no grupo do cliente.
**How to apply:** qualquer novo caminho de compartilhamento no fechamento de OS deve escolher o texto por `isDHL` (padrão DHL vs relatório interno).
